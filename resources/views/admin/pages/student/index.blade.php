...
<div class="student-page">
    <div class="page-hero">
        <div class="row align-items-center">
            <div class="col-lg-8">
                <h3>@if ($voruv == 'v') Total Students @elseif($voruv == 'uv') Unverified Students @else Students @endif</h3>
                <p>Manage verified and unverified student records, activity, and detailed exports.</p>
            </div>
            <div class="col-lg-4">
...
<a href="{{ route('all.student.export') }}" class="btn btn-primary btn-sm"><i class="fa fa-download mr-1" aria-hidden="true"></i> Download Details</a>
    ...
    <div class="card content-card">
        <div class="card-header">
            <h4 class="card-title">@if ($voruv == 'v') Total Students @elseif($voruv == 'uv') Unverified Students @else Students @endif</h4>
            <p class="section-subtitle">Manage verified and unverified student records, activity, and detailed exports.</p>
        </div>

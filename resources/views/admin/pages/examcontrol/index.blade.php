...
">
                        ...
                        <div class="form-group row">
                            <label class="col-form-label col-md-3">Bootcamp Date</label>
                            <div class="col-md-9">
                                <input type="datetime-local" name="bootcamp_date" value="{{ $exam->bootcamp_date }}"
                                    class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row text-center justify-content-center">
                            <h3 class="d-block text-center w-100"><u>First Round</u></h3>
                            <div class="col-md-6 my-4 text-muted">
                                <div class="border px-2 py-3">
                                    <p>Start exam date mail & SMS Send to all student</p>
                                    <a href="{{ route('exam.time.mail') }}" class="btn btn-primary btn-sm">Send Start
                                        Exam
                                        Mail & SMS</a>
                                </div>
                            </div>
                            <div class="col-md-6 my-4 text-muted">
                                <div class="border px-2 py-3">
                                    ...
                                    <a href="{{ route('result.published.mail') }}" class="btn btn-primary btn-sm">Send
                                        Result
                                        Published Mail & SMS</a>
                                </div>
                            </div>
                            <h3 class="d-block text-center w-100"><u>Second Round</u></h3>
                            <div class="col-md-6 my-4 text-muted">
                                <div class="border px-2 py-3">
                            ...
                            <div class="col-md-6 my-4 text-muted">
                                <div class="border px-2 py-3">
                                    ...
                                    <a href="{{ route('result.published.mail.round.two') }}"
                                        class="btn btn-primary btn-sm">Send Result
                                        Published Mail & SMS</a>
                                </div>
                            </div>
                            <h3 class="d-block text-center w-100"><u>Bootcamp</u></h3>
                            <div class="col-md-12 my-4 text-muted">
                                <div class="border px-2 py-3">
                                    <p>Bootcamp mail & SMS Send to only selected student</p>
                                    <a href="{{ route('bootcamp.mail') }}" class="btn btn-primary btn-sm">Send Bootcamp
                                        Mail
                                        & SMS</a>
                                </div>
                            </div>
                            {{--  Third Round --}}
                            <h3 class="d-block text-center w-100"><u>Third Round</u></h3>
                            <div class="col-md-6 my-4 text-muted">
                                <div class="border px-2 py-3">
                                    <p>Selected for third round mail & SMS Send to only selected student</p>
                                    <a href="{{ route('selected.third.mail') }}" class="btn btn-primary btn-sm">Send
                                        Selected
                                        Mail & SMS</a>
                                </div>
                            </div>
                            <div class="col-md-6 my-4 text-muted">
                                <div class="border px-2 py-3">
                                    ...
                                    <a href="{{ route('result.published.mail.round.third') }}"
                                        class="btn btn-primary btn-sm">Send Result
                                        Published Mail & SMS</a>
                                </div>
                            </div>

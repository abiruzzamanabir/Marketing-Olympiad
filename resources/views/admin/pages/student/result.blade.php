    ...
    <div class="student-page">
        <div class="page-hero">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h3>Round One Result (Top 1000)</h3>
                    <p>Review round one scores, duration, status, and participant actions.</p>
                </div>
                <div class="col-lg-4">
                    <div class="hero-actions">

                        <a class="btn btn-warning btn-sm" href="{{ route('student.block') }}"><i class="fa fa-ban mr-1"
                                aria-hidden="true"></i> Ban Student</a>
                        <a class="btn btn-danger btn-sm" href="{{ route('student.trash') }}"><i class="fa fa-trash mr-1"
                                aria-hidden="true"></i> Trash Student</a>
                        <a href="{{ route('round.one.export') }}" class="btn btn-primary btn-sm"><i
                                class="fa fa-download mr-1" aria-hidden="true"></i> Download Result Sheet</a>
        ...
        <div class="card content-card">
            <div class="card-header">
                ...
                <p class="section-subtitle">Review round one scores, duration, status, and participant actions.</p>
            </div>
        ...
        $(document).ready(function() {
            var table = $('#listRender').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'round_one_result',
                        name: 'round_one_result'
                    },
                    {
                        data: 'duration',
                        name: 'duration'
